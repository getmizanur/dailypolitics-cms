...
class AbstractEntity {
     ...
     */
    exchangeObject(data) {
        throw new Error(`${this.constructor.name}::exchangeObject() must be implemented by subclass`);
    }
     ...
     */
    getObjectCopy() {
        throw new Error(`${this.constructor.name}::getObjectCopy() must be implemented by subclass`);
    }
     ...
     */
    toJSON(pretty = false) {
        return JsonUtil.encode(this.storage, { pretty, space: 2 });
    }
