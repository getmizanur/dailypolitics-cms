...
class HtmlEntities {
    ...
    getHtmlTranslationTable(table, quoteStyle) {
        let entities = {}, hashMap = {}, decimal;
        let constMappingTable = {}, constMappingQuoteStyle = {};
        let useTable = {}, useQuoteStyle = {};
    ...
    htmlEntities(string, quoteStyle, charset, doubleEncode) {
        let hashMap 
            = this.getHtmlTranslationTable('HTML_ENTITIES', quoteStyle), symbol = '';
